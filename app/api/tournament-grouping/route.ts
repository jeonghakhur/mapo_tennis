...
import { createGroupMatches, calculateGroupStandings } from '@/service/tournamentGrouping';

// 예선 경기 생성 핸들러
async function createMatchesHandler(req: NextRequest) {
  try {
...
// 조별 순위 계산 핸들러
async function calculateStandingsHandler(req: NextRequest) {
  try {
